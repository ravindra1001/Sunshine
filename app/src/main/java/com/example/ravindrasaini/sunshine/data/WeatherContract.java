package com.example.ravindrasaini.sunshine.data;
...
public class WeatherContract {
    public static final String CONTENT_AUTHORITY  = "com.example.ravindrasaini.sunshine";
    ...
    public static final class LocationEntry implements BaseColumns{
        ...
        public static Uri buiilLocationUri(long _id){
    ...
    public static final class WeatherEntry implements BaseColumns{
        ...
        public static final String CLOUMN_WEATHER_ID = "weather_id";
        ...
        public static final String COLUMN_DEGREES = "deg";
